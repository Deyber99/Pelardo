...
class CitasServiceTest {
    ...
    @Test
    void testMostrarCitaSuccess() throws Exception {
    ...
    @Test
    void testMostrarCitaExceptionReturnsEmptyList() throws Exception {
        try (MockedStatic<CitasRepository> mockedRepository = mockStatic(CitasRepository.class)) {
            mockedRepository.when(() -> CitasRepository.mostrarCita("2026-06-01"))
    ...
    @Test
    void testInsertCitaBlankFieldsThrowsException() {
    ...
    @Test
    void testInsertCitaSuccess() throws Exception {
        try (MockedStatic<CitasRepository> mockedRepository = mockStatic(CitasRepository.class)) {
            assertDoesNotThrow(() ->
    ...
    @Test
    void testUpdateCitaBlankFieldsThrowsException() {
    ...
    @Test
    void testUpdateCitaSuccess() throws Exception {
    ...
    @Test
    void testDeleteCitaSuccess() throws Exception {
